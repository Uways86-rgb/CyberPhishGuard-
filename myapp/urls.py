...
urlpatterns = [
    ...
    path('scan-management/clear/', views.clear_scan_history, name='clear_scan_history'),
    path('all-threats/', views.all_threats, name='all_threats'),
    path('threat-delete/<int:threat_id>/', views.threat_delete, name='threat_delete'),
    path('all-threats/clear/', views.clear_threat_history, name='clear_threat_history'),
